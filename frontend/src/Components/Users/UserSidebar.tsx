...
import { FaUser, FaBars, FaRegListAlt, FaTimes } from 'react-icons/fa';
...
function UserSidebar() {
    ...
    return (
        <>
            ...
            <div
                ref={sidebarRef}
                className={`hidden lg:block fixed z-10 top-14 left-0 h-[calc(100vh-3.5rem)] bg-white text-gray-800 transition-all duration-300 ${isExpanded ? 'w-64' : 'w-16'
                    } overflow-hidden shadow-lg border-r border-gray-200`}
            >
